...
export JENKINS_X_URL='https://dashboard-jx.jx.mqube.build/spring-financial-group/docker-credential-acr-env/master/6'
...
export MINK_IMAGE='jx3mqubebuild.azurecr.io/spring-financial-group/docker-credential-acr-env:0.0.21'
